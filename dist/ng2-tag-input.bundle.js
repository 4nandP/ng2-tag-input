...
var TagInputDropdown = (function () {
    ...
    TagInputDropdown.prototype.addNewItem = function (item) {
        ...
        if (this.tagInput.isTagValid(item.value, true)) {
            var tag = this.tagInput.createTag(item.value[this.displayBy], item.value[this.identifyBy], item.value[this.classBy]);
...
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], TagInputDropdown.prototype, "classBy", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", Function)
...
var TagInputComponent = TagInputComponent_1 = (function (_super) {
    ...
    TagInputComponent.prototype.createTag = function (display, value, className) {
        return _a = {},
            _a[this.displayBy] = display,
            _a[this.identifyBy] = value,
            _a[this.classBy] = className,
            _a;
        var _a;
    };
    ...
    TagInputComponent.prototype.setItemClass = function (item) {
...
__decorate([
    core_1.Input(),
    __metadata("design:type", String)
], TagInputAccessor.prototype, "classBy", void 0);
...
// module
exports.push([module.i, ".progress-bar, .progress-bar:before {\n  height: 2px;\n  width: 100%;\n  margin: 0; }\n\n.progress-bar {\n  background-color: #2196F3;\n  display: flex;\n  position: absolute;\n  bottom: 0; }\n\n.progress-bar:before {\n  background-color: #82c4f8;\n  content: '';\n  -webkit-animation: running-progress 2s cubic-bezier(0.4, 0, 0.2, 1) infinite;\n  animation: running-progress 2s cubic-bezier(0.4, 0, 0.2, 1) infinite; }\n\n@-webkit-keyframes running-progress {\n  0% {\n    margin-left: 0;\n    margin-right: 100%; }\n  50% {\n    margin-left: 25%;\n    margin-right: 0; }\n  100% {\n    margin-left: 100%;\n    margin-right: 0; } }\n\n@keyframes running-progress {\n  0% {\n    margin-left: 0;\n    margin-right: 100%; }\n  50% {\n    margin-left: 25%;\n    margin-right: 0; }\n  100% {\n    margin-left: 100%;\n    margin-right: 0; } }\n\n.ng2-tag-input {\n  display: flex;\n  flex-direction: row;\n  flex-wrap: wrap;\n  transition: all 0.15s;\n  padding: 0.25rem 0.2rem;\n  min-height: 32px;\n  cursor: text;\n  position: relative; }\n\n.ng2-tag-input:focus {\n  outline: 0; }\n\n.ng2-tags-container {\n  flex-wrap: wrap;\n  display: flex; }\n\n.ng2-tag-input form {\n  margin: 0.1em 0; }\n\n.ng2-tag-input__error-message {\n  font-size: 0.8em;\n  color: #f44336;\n  margin: 0.5em 0; }\n\n.default.ng2-tag-input.ng2-tag-input--invalid,\n.minimal.ng2-tag-input.ng2-tag-input--invalid,\n.dark.ng2-tag-input.ng2-tag-input--invalid {\n  border-bottom: 2px solid #f44336; }\n\n.default.ng2-tag-input.ng2-tag-input--loading,\n.dark.ng2-tag-input.ng2-tag-input--loading,\n.minimal.ng2-tag-input.ng2-tag-input--loading {\n  border: none; }\n\n.ng2-tag-input.default {\n  border-bottom: 2px solid #efefef; }\n\n.default.ng2-tag-input--focused {\n  border-bottom: 2px solid #2196F3; }\n\n.ng2-tag-input.minimal {\n  border-bottom: 1px solid transparent; }\n\n.ng2-tag-input.dark {\n  border-bottom: 2px solid #212121; }\n\ntag {\n  display: flex;\n  flex-direction: row;\n  flex-wrap: wrap;\n  font-family: \"Roboto\", \"Helvetica Neue\", sans-serif;\n  font-weight: 400;\n  font-size: 1em;\n  letter-spacing: 0.05rem;\n  outline: 0;\n  color: #444;\n  cursor: pointer;\n  border-radius: 16px;\n  transition: all 0.25s;\n  margin: 0.1rem 0.2rem;\n  padding: 0.08rem 0.45rem;\n  height: 32px;\n  line-height: 34px;\n  user-select: none;\n  overflow: hidden; }\n\ntag.readonly {\n  cursor: default; }\n\ntag.readonly:focus {\n  outline: 0; }\n\ntag.red-tag {\n  background-color: #ff1e1e;\n  color: #fff; }\n\n.default tag.red-tag:not(.tag--editing) {\n  background-color: #ff1e1e; }\n\n.default tag.red-tag:not(.readonly):not(.tag--editing):focus {\n  background-color: #bf1a1a;\n  color: #fff; }\n\n.default tag.red-tag:not(.readonly):not(.tag--editing):active {\n  background: #a91717;\n  color: #fff; }\n\n.default tag.red-tag:not(:focus):not(.tag--editing):not(:active):not(.readonly):hover {\n  background: #a91717; }\n\ntag.yellow-tag {\n  background-color: #f1d525;\n  color: #fff; }\n\n.default tag.yellow-tag:not(.tag--editing) {\n  background-color: #f1d525; }\n\n.default tag.yellow-tag:not(.readonly):not(.tag--editing):focus {\n  background-color: #ffac1e;\n  color: #fff; }\n\n.default tag.yellow-tag:not(.readonly):not(.tag--editing):active {\n  background: #ffa305;\n  color: #fff; }\n\n.default tag.yellow-tag:not(:focus):not(.tag--editing):not(:active):not(.readonly):hover {\n  background: #ffa305; }\n\ntag.green-tag {\n  background-color: #28ba3c;\n  color: #fff; }\n\n.default tag.green-tag:not(.tag--editing) {\n  background-color: #28ba3c; }\n\n.default tag.green-tag:not(.readonly):not(.tag--editing):focus {\n  background-color: #238934;\n  color: #fff; }\n\n.default tag.green-tag:not(.readonly):not(.tag--editing):active {\n  background: #1e752c;\n  color: #fff; }\n\n.default tag.green-tag:not(:focus):not(.tag--editing):not(:active):not(.readonly):hover {\n  background: #1e752c; }\n\ntag.blue-tag {\n  background-color: #33d3d6;\n  color: #fff; }\n\n.default tag.blue-tag:not(.tag--editing) {\n  background-color: #33d3d6; }\n\n.default tag.blue-tag:not(.readonly):not(.tag--editing):focus {\n  background-color: #2f99d6;\n  color: #fff; }\n\n.default tag.blue-tag:not(.readonly):not(.tag--editing):active {\n  background: #278bc5;\n  color: #fff; }\n\n.default tag.blue-tag:not(:focus):not(.tag--editing):not(:active):not(.readonly):hover {\n  background: #278bc5; }\n\ntag.dark-blue-tag {\n  background-color: #2b41e5;\n  color: #fff; }\n\n.default tag.dark-blue-tag:not(.tag--editing) {\n  background-color: #2b41e5; }\n\n.default tag.dark-blue-tag:not(.readonly):not(.tag--editing):focus {\n  background-color: #182cbf;\n  color: #fff; }\n\n.default tag.dark-blue-tag:not(.readonly):not(.tag--editing):active {\n  background: #1527a8;\n  color: #fff; }\n\n.default tag.dark-blue-tag:not(:focus):not(.tag--editing):not(:active):not(.readonly):hover {\n  background: #1527a8; }\n\ntag.purple-tag {\n  background-color: #8f18bf;\n  color: #fff; }\n\n.default tag.purple-tag:not(.tag--editing) {\n  background-color: #8f18bf; }\n\n.default tag.purple-tag:not(.readonly):not(.tag--editing):focus {\n  background-color: #7c18bf;\n  color: #fff; }\n\n.default tag.purple-tag:not(.readonly):not(.tag--editing):active {\n  background: #6d15a8;\n  color: #fff; }\n\n.default tag.purple-tag:not(:focus):not(.tag--editing):not(:active):not(.readonly):hover {\n  background: #6d15a8; }\n\n.default tag.tag--editing,\n.dark tag.tag--editing,\n.minimal tag.tag--editing {\n  background-color: #fff;\n  cursor: text; }\n\ntag:focus {\n  outline: 0; }\n\n.default tag:not(.tag--editing) {\n  background: #efefef; }\n\n.default tag:not(.readonly):not(.tag--editing):focus {\n  background: #2196F3;\n  color: #fff; }\n\n.default tag:not(.readonly):not(.tag--editing):active {\n  background: #0d8aee;\n  color: #fff; }\n\n.default tag:not(:focus):not(.tag--editing):not(:active):not(.readonly):hover {\n  background: #e2e2e2; }\n\n.minimal tag {\n  background: #f9f9f9;\n  border-radius: 0; }\n\n.minimal tag:not(.readonly):focus,\n.minimal tag:not(.readonly):active {\n  background: #dddddd; }\n\n.minimal tag:not(:focus):not(.readonly):hover {\n  background: #ececec; }\n\n.minimal tag:not(:focus):not(.readonly):hover {\n  background: #ececec; }\n\n.dark tag {\n  background: #212121;\n  color: #f9f9f9; }\n\n.dark tag:not(.readonly):focus,\n.dark tag:not(.readonly):active {\n  background: #999999;\n  color: #212121; }\n", ""]);
